<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.adminId" placeholder="ID" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/admin'
